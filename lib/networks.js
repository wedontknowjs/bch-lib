...
var owsCommon = require('@wedontknowjs/ows-common');
...
addNetwork({
  ...
  port: 2018,
  dnsSeeds: [
    'comseeder.miningspeed.com',
    'seed1.commercium.net',
    'seed2.commercium.net'
  ]
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    'testnet-seed1.commercium.net',
    'testnet-seed2.commercium.net'
  ]
};
